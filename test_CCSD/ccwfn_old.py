...
This is used for checking my implementation of local CCSD - lccwfn.py where the simulation code only runs through the doubles while the t1 are in the canonical form
"""
...
class ccwfn_old(object):
    ...
    def __init__(self, scf_wfn, **kwargs):
        ...
        if local is not None:
            ...
            self.t2 = self.Local.filter_t2amps(self.H.ERI[o,o,v,v])
        else:
            self.t1 = np.zeros((self.no, self.nv))
            self.t2 = self.H.ERI[o,o,v,v]/self.Dijab
    ...
    def solve_cc(self, e_conv=1e-7, r_conv=1e-7, maxiter=100, max_diis=8, start_diis=8):
        ...
        for niter in range(1, maxiter+1):
            ...
            if self.local is not None:
                ...
                inc2 = self.Local.filter_t2amps(r2) 
            ...
            if ((abs(ediff) < e_conv) and rms < r_conv):
                ...
                #print(self.no)
                #print(self.nv)
                #with open("t1_amps.out","a") as f1:
                    #for i in range(self.no):
                        #for a in range(self.nv):
                            #f1.write( str(i) + " " + str(a) + " " + str(self.t1[i,a]) + '\n') 
                return ecc
    ...
    def residuals(self, F, t1, t2):
        ...
        Faet2 = self.build_Faet2(o, v, F, L, t1, t2)
        ...
        r2 = self.r_T2(o, v, F, ERI, L, t1, t2, Faet2, Fmi, Fme, Wmnij, Zmbij, Wmbej)# , Wmbej, Wmbje, Zmbij)
    ...
    def build_tau(self, t1, t2, fact1=1.0, fact2=1.0):
        ...
        return fact1 * t2
        #return fact2 * contract('ia,jb->ijab', t1, t1) 
    ...
    def build_Faet2(self, o, v, F, L, t1, t2):
        Fae = F[v,v].copy()
        Fae = Fae - 0.5 * contract('me,ma->ae', F[o,v], t1)
        Fae = Fae + contract('mf,mafe->ae', t1, L[o,v,v,v])
        #Fae = Fae - contract('mnaf,mnef->ae', self.build_tau(t1, t2, 1.0, 0.5), L[o,o,v,v])
    ...
    def r_T2(self, o, v, F, ERI, L, t1, t2, Fae,Fmi, Fme, Wmnij,Zmbij,Wmbej): #  Wmbej, Wmbje, Zmbij)
        if self.model == 'CCD':
            ...
            r_T2 = r_T2 + 0.5 * contract('mnab,mnij->ijab', self.build_tau(t1, t2), Wmnij) #r2_7
            r_T2 = r_T2 + 0.5 * contract('ijef,abef->ijab', self.build_tau(t1, t2), ERI[v,v,v,v]) #r2_8
            #r_T2 = r_T2 - contract('ma,mbij->ijab', t1, Zmbij) #r2_9 - error
            #r_T2 = r_T2 + contract('imae,mbej->ijab', (t2 - t2.swapaxes(2,3)), Wmbej) #r2_10 - error
            #r_T2 = r_T2 + contract('imae,mbej->ijab', t2, (Wmbej + Wmbje.swapaxes(2,3))) 
            #r_T2 = r_T2 + contract('mjae,mbie->ijab', t2, Wmbje)
