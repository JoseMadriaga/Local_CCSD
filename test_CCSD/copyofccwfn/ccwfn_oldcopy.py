...
This is just an copy of the old version of ccwfn just for reassurance
"""
...
class ccwfn_old(object):
    ...
    def residuals(self, F, t1, t2):
        ...
        r2 = self.r_T2(o, v, F, ERI, L, t1, t2, Fae) #, Fmi) Fme, Wmnij, Wmbej, Wmbje, Zmbij)
    ...
    def r_T2(self, o, v, F, ERI, L, t1, t2, Fae): #, Fmi): #, Fme, Fmi, Wmnij, Wmbej, Wmbje, Zmbij)
        if self.model == 'CCD':
