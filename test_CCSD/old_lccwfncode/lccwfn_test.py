    ...
    def build_localFae(self, o, v, Fvv_ij,Fov_ii, Lovvv_ij, Loovv_ij, t1, t2_ij):
        ...
        for ij in range(self.no*self.no):
            ...
            #Fae1 -= L[ij].T @ Q[ij].T @ tmp @ Q[ij] @ L[ij]
                ...
                Fae1 = np_zeoes
                Fae1 -= 0.5* contract('e,B,Bb->be',Fov_ii[ij][m],Y,Sijmm)
                ...
                Fae2 += contract('F,bfe,fF->be',Y,Lovvv_ij[ij][m],Sijmm)
            ...
            #for mn in range(self.no*self.no): 
                ...
                #Fae3 -= contract('bB,BF,ef,fF->be',Sijmn, self.build_localtau(mn,mn,t1,t2_ij,1.0,0.5),Loovv_ij[ij][m,n],Sijmn)
